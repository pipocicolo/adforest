...
public class UrlController {
    ...
    private static String Purchase_code = "ae841c4e-8150-440e-8970-65b6c56183b5";//Enter the purchase code here
    private static String Custom_Security = "1234";//Enter the Custom Security code here
    private static String IP_ADDRESS = "http://moretor.com/";//Enter You Ip_Address here here
