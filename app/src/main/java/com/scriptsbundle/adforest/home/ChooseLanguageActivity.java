...
public class ChooseLanguageActivity extends AppCompatActivity {
    ...
    private TextView headingChooseLanguage, boldLang;
    RecyclerView recyclerView;
    RelativeLayout relativeLayout;
    static String image, title1, title2,isMultiLine,MainHeading;
    ...
    private void adforest_setAllLanguages() {
        ...
        adapter.setItemLanguageOnclicklinstener(chooseLanguageModel -> {
